...
final $typed_data.Uint8List queryGroupInfoRequestDescriptor = $convert.base64Decode(
...
const QueryGroupInfoResponse$json = {
  ...
  '2': [
    {'1': 'info', '3': 1, '4': 1, '5': 11, '6': '.cosmos.group.v1.GroupInfo', '10': 'info'},
  ],
};

/// Descriptor for `QueryGroupInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGroupInfoResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryGroupPolicyInfoRequestDescriptor = $convert.base64Decode(
...
const QueryGroupPolicyInfoResponse$json = {
  ...
  '2': [
    {'1': 'info', '3': 1, '4': 1, '5': 11, '6': '.cosmos.group.v1.GroupPolicyInfo', '10': 'info'},
  ],
};

/// Descriptor for `QueryGroupPolicyInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGroupPolicyInfoResponseDescriptor = $convert.base64Decode(
...
const QueryGroupMembersResponse$json = {
  ...
  '2': [
    {'1': 'members', '3': 1, '4': 3, '5': 11, '6': '.cosmos.group.v1.GroupMember', '10': 'members'},
...
final $typed_data.Uint8List queryGroupsByAdminResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryGroupPoliciesByGroupRequestDescriptor = $convert.base64Decode(
...
const QueryGroupPoliciesByGroupResponse$json = {
  ...
  '2': [
    {'1': 'group_policies', '3': 1, '4': 3, '5': 11, '6': '.cosmos.group.v1.GroupPolicyInfo', '10': 'groupPolicies'},
    {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryGroupPoliciesByGroupResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGroupPoliciesByGroupResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryGroupPoliciesByAdminRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryGroupPoliciesByAdminResponseDescriptor = $convert.base64Decode(
...
const QueryProposalResponse$json = {
  ...
  '2': [
    {'1': 'proposal', '3': 1, '4': 1, '5': 11, '6': '.cosmos.group.v1.Proposal', '10': 'proposal'},
  ],
};
...
final $typed_data.Uint8List queryProposalsByGroupPolicyRequestDescriptor = $convert.base64Decode(
...
const QueryProposalsByGroupPolicyResponse$json = {
  ...
  '2': [
    {'1': 'proposals', '3': 1, '4': 3, '5': 11, '6': '.cosmos.group.v1.Proposal', '10': 'proposals'},
    {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryProposalsByGroupPolicyResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryProposalsByGroupPolicyResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryVoteByProposalVoterRequestDescriptor = $convert.base64Decode(
...
const QueryVoteByProposalVoterResponse$json = {
  ...
  '2': [
    {'1': 'vote', '3': 1, '4': 1, '5': 11, '6': '.cosmos.group.v1.Vote', '10': 'vote'},
  ],
};

/// Descriptor for `QueryVoteByProposalVoterResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryVoteByProposalVoterResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryVotesByProposalRequestDescriptor = $convert.base64Decode(
...
const QueryVotesByProposalResponse$json = {
  ...
  '2': [
    {'1': 'votes', '3': 1, '4': 3, '5': 11, '6': '.cosmos.group.v1.Vote', '10': 'votes'},
    {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryVotesByProposalResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryVotesByProposalResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryGroupsByMemberRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryGroupsByMemberResponseDescriptor = $convert.base64Decode(
...
const QueryTallyResultResponse$json = {
  ...
  '2': [
    {'1': 'tally', '3': 1, '4': 1, '5': 11, '6': '.cosmos.group.v1.TallyResult', '8': {}, '10': 'tally'},
  ],
};
