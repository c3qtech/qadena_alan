...
class Member extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Member', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'address')
    ..aOS(2, _omitFieldNames ? '' : 'weight')
    ..aOS(3, _omitFieldNames ? '' : 'metadata')
    ..aOM<$2.Timestamp>(4, _omitFieldNames ? '' : 'addedAt', subBuilder: $2.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $2.Timestamp get addedAt => $_getN(3);
  @$pb.TagNumber(4)
  set addedAt($2.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAddedAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearAddedAt() => clearField(4);
  @$pb.TagNumber(4)
  $2.Timestamp ensureAddedAt() => $_ensure(3);
}
...
class MemberRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MemberRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'address')
    ..aOS(2, _omitFieldNames ? '' : 'weight')
    ..aOS(3, _omitFieldNames ? '' : 'metadata')
    ..hasRequiredFields = false
...
class ThresholdDecisionPolicy extends $pb.GeneratedMessage {
  ...
  factory ThresholdDecisionPolicy.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ThresholdDecisionPolicy.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ThresholdDecisionPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'threshold')
    ..aOM<DecisionPolicyWindows>(2, _omitFieldNames ? '' : 'windows', subBuilder: DecisionPolicyWindows.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ThresholdDecisionPolicy clone() => ThresholdDecisionPolicy()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ThresholdDecisionPolicy copyWith(void Function(ThresholdDecisionPolicy) updates) => super.copyWith((message) => updates(message as ThresholdDecisionPolicy)) as ThresholdDecisionPolicy;
  ...
  static $pb.PbList<ThresholdDecisionPolicy> createRepeated() => $pb.PbList<ThresholdDecisionPolicy>();
  @$core.pragma('dart2js:noInline')
  static ThresholdDecisionPolicy getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ThresholdDecisionPolicy>(create);
  ...
  @$pb.TagNumber(1)
  set threshold($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set windows(DecisionPolicyWindows v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class PercentageDecisionPolicy extends $pb.GeneratedMessage {
  ...
  factory PercentageDecisionPolicy.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PercentageDecisionPolicy.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PercentageDecisionPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PercentageDecisionPolicy clone() => PercentageDecisionPolicy()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PercentageDecisionPolicy copyWith(void Function(PercentageDecisionPolicy) updates) => super.copyWith((message) => updates(message as PercentageDecisionPolicy)) as PercentageDecisionPolicy;
  ...
  static $pb.PbList<PercentageDecisionPolicy> createRepeated() => $pb.PbList<PercentageDecisionPolicy>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set percentage($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class DecisionPolicyWindows extends $pb.GeneratedMessage {
  ...
  factory DecisionPolicyWindows.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DecisionPolicyWindows', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
    ..aOM<$3.Duration>(1, _omitFieldNames ? '' : 'votingPeriod', subBuilder: $3.Duration.create)
    ..aOM<$3.Duration>(2, _omitFieldNames ? '' : 'minExecutionPeriod', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DecisionPolicyWindows clone() => DecisionPolicyWindows()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DecisionPolicyWindows copyWith(void Function(DecisionPolicyWindows) updates) => super.copyWith((message) => updates(message as DecisionPolicyWindows)) as DecisionPolicyWindows;
  ...
  static $pb.PbList<DecisionPolicyWindows> createRepeated() => $pb.PbList<DecisionPolicyWindows>();
  @$core.pragma('dart2js:noInline')
  static DecisionPolicyWindows getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DecisionPolicyWindows>(create);
  ...
  @$pb.TagNumber(1)
  set votingPeriod($3.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $3.Duration get minExecutionPeriod => $_getN(1);
  @$pb.TagNumber(2)
  set minExecutionPeriod($3.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMinExecutionPeriod() => $_has(1);
  @$pb.TagNumber(2)
  void clearMinExecutionPeriod() => clearField(2);
  @$pb.TagNumber(2)
  $3.Duration ensureMinExecutionPeriod() => $_ensure(1);
}
...
class GroupInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroupInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(5)
  set totalWeight($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
...
class GroupMember extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroupMember', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
...
class GroupPolicyInfo extends $pb.GeneratedMessage {
  ...
  factory GroupPolicyInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GroupPolicyInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroupPolicyInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'address')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GroupPolicyInfo copyWith(void Function(GroupPolicyInfo) updates) => super.copyWith((message) => updates(message as GroupPolicyInfo)) as GroupPolicyInfo;
  ...
  static $pb.PbList<GroupPolicyInfo> createRepeated() => $pb.PbList<GroupPolicyInfo>();
  @$core.pragma('dart2js:noInline')
  static GroupPolicyInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GroupPolicyInfo>(create);
...
class Proposal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Proposal', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(2, _omitFieldNames ? '' : 'groupPolicyAddress')
    ..aOS(3, _omitFieldNames ? '' : 'metadata')
    ..pPS(4, _omitFieldNames ? '' : 'proposers')
    ..aOM<$2.Timestamp>(5, _omitFieldNames ? '' : 'submitTime', subBuilder: $2.Timestamp.create)
    ...
    ..aOM<$2.Timestamp>(10, _omitFieldNames ? '' : 'votingPeriodEnd', subBuilder: $2.Timestamp.create)
    ...
    ..pc<$4.Any>(12, _omitFieldNames ? '' : 'messages', $pb.PbFieldType.PM, subBuilder: $4.Any.create)
  ...
  @$pb.TagNumber(6)
  set groupVersion($fixnum.Int64 v) { $_setInt64(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set groupPolicyVersion($fixnum.Int64 v) { $_setInt64(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set status(ProposalStatus v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set finalTallyResult(TallyResult v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  /// accordingly updated.
  @$pb.TagNumber(10)
  $2.Timestamp get votingPeriodEnd => $_getN(9);
  @$pb.TagNumber(10)
  set votingPeriodEnd($2.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasVotingPeriodEnd() => $_has(9);
  @$pb.TagNumber(10)
  void clearVotingPeriodEnd() => clearField(10);
  @$pb.TagNumber(10)
  $2.Timestamp ensureVotingPeriodEnd() => $_ensure(9);

  /// executor_result is the final result of the proposal execution. Initial value is NotRun.
  @$pb.TagNumber(11)
  ProposalExecutorResult get executorResult => $_getN(10);
  @$pb.TagNumber(11)
  set executorResult(ProposalExecutorResult v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class TallyResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TallyResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
...
class Vote extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Vote', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.v1'), createEmptyInstance: create)
