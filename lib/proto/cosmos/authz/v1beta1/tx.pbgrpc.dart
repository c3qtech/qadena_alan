...
class MsgClient extends $grpc.Client {
  ...
  static final _$revoke = $grpc.ClientMethod<$0.MsgRevoke, $0.MsgRevokeResponse>(
      '/cosmos.authz.v1beta1.Msg/Revoke',
      ($0.MsgRevoke value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.MsgRevokeResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.MsgGrantResponse> grant($0.MsgGrant request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.MsgRevokeResponse> revoke($0.MsgRevoke request, {$grpc.CallOptions? options}) {
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.MsgGrantResponse> grant_Pre($grpc.ServiceCall call, $async.Future<$0.MsgGrant> request) async {
  ...
  $async.Future<$0.MsgRevokeResponse> revoke_Pre($grpc.ServiceCall call, $async.Future<$0.MsgRevoke> request) async {
    return revoke(call, await request);
  }

  $async.Future<$0.MsgGrantResponse> grant($grpc.ServiceCall call, $0.MsgGrant request);
  $async.Future<$0.MsgExecResponse> exec($grpc.ServiceCall call, $0.MsgExec request);
  $async.Future<$0.MsgRevokeResponse> revoke($grpc.ServiceCall call, $0.MsgRevoke request);
}
