...
class QuerySubspacesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuerySubspacesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.params.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QuerySubspacesRequest copyWith(void Function(QuerySubspacesRequest) updates) => super.copyWith((message) => updates(message as QuerySubspacesRequest)) as QuerySubspacesRequest;
...
class QuerySubspacesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuerySubspacesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.params.v1beta1'), createEmptyInstance: create)
    ..pc<Subspace>(1, _omitFieldNames ? '' : 'subspaces', $pb.PbFieldType.PM, subBuilder: Subspace.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QuerySubspacesResponse copyWith(void Function(QuerySubspacesResponse) updates) => super.copyWith((message) => updates(message as QuerySubspacesResponse)) as QuerySubspacesResponse;
...
class Subspace extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Subspace', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.params.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'subspace')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Subspace copyWith(void Function(Subspace) updates) => super.copyWith((message) => updates(message as Subspace)) as Subspace;
