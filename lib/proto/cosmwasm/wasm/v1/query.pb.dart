...
class QueryCodeInfoRequest extends $pb.GeneratedMessage {
  ...
  factory QueryCodeInfoRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryCodeInfoRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryCodeInfoRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmwasm.wasm.v1'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'codeId', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryCodeInfoRequest clone() => QueryCodeInfoRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryCodeInfoRequest copyWith(void Function(QueryCodeInfoRequest) updates) => super.copyWith((message) => updates(message as QueryCodeInfoRequest)) as QueryCodeInfoRequest;
  ...
  static $pb.PbList<QueryCodeInfoRequest> createRepeated() => $pb.PbList<QueryCodeInfoRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryCodeInfoRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryCodeInfoRequest>(create);
...
class QueryCodeInfoResponse extends $pb.GeneratedMessage {
  ...
  factory QueryCodeInfoResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryCodeInfoResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryCodeInfoResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmwasm.wasm.v1'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'codeId', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryCodeInfoResponse clone() => QueryCodeInfoResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryCodeInfoResponse copyWith(void Function(QueryCodeInfoResponse) updates) => super.copyWith((message) => updates(message as QueryCodeInfoResponse)) as QueryCodeInfoResponse;
  ...
  static $pb.PbList<QueryCodeInfoResponse> createRepeated() => $pb.PbList<QueryCodeInfoResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryCodeInfoResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryCodeInfoResponse>(create);
...
class QueryWasmLimitsConfigRequest extends $pb.GeneratedMessage {
  factory QueryWasmLimitsConfigRequest() => create();
  QueryWasmLimitsConfigRequest._() : super();
  factory QueryWasmLimitsConfigRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryWasmLimitsConfigRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryWasmLimitsConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmwasm.wasm.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryWasmLimitsConfigRequest clone() => QueryWasmLimitsConfigRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryWasmLimitsConfigRequest copyWith(void Function(QueryWasmLimitsConfigRequest) updates) => super.copyWith((message) => updates(message as QueryWasmLimitsConfigRequest)) as QueryWasmLimitsConfigRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static QueryWasmLimitsConfigRequest create() => QueryWasmLimitsConfigRequest._();
  QueryWasmLimitsConfigRequest createEmptyInstance() => create();
  static $pb.PbList<QueryWasmLimitsConfigRequest> createRepeated() => $pb.PbList<QueryWasmLimitsConfigRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryWasmLimitsConfigRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryWasmLimitsConfigRequest>(create);
  static QueryWasmLimitsConfigRequest? _defaultInstance;
}
...
class QueryWasmLimitsConfigResponse extends $pb.GeneratedMessage {
  factory QueryWasmLimitsConfigResponse({
    $core.String? config,
  }) {
    final $result = create();
    if (config != null) {
  ...
  QueryWasmLimitsConfigResponse._() : super();
  factory QueryWasmLimitsConfigResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryWasmLimitsConfigResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryWasmLimitsConfigResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmwasm.wasm.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryWasmLimitsConfigResponse clone() => QueryWasmLimitsConfigResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryWasmLimitsConfigResponse copyWith(void Function(QueryWasmLimitsConfigResponse) updates) => super.copyWith((message) => updates(message as QueryWasmLimitsConfigResponse)) as QueryWasmLimitsConfigResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static QueryWasmLimitsConfigResponse create() => QueryWasmLimitsConfigResponse._();
  QueryWasmLimitsConfigResponse createEmptyInstance() => create();
  static $pb.PbList<QueryWasmLimitsConfigResponse> createRepeated() => $pb.PbList<QueryWasmLimitsConfigResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryWasmLimitsConfigResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryWasmLimitsConfigResponse>(create);
  static QueryWasmLimitsConfigResponse? _defaultInstance;
