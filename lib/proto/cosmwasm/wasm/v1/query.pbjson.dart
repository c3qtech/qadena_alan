...
const QueryCodeInfoRequest$json = {
...
final $typed_data.Uint8List queryCodeInfoRequestDescriptor = $convert.base64Decode(
    'ChRRdWVyeUNvZGVJbmZvUmVxdWVzdBIXCgdjb2RlX2lkGAEgASgEUgZjb2RlSWQ=');

@$core.Deprecated('Use queryCodeInfoResponseDescriptor instead')
const QueryCodeInfoResponse$json = {
  '1': 'QueryCodeInfoResponse',
  '2': [
    {'1': 'code_id', '3': 1, '4': 1, '5': 4, '8': {}, '10': 'codeId'},
    {'1': 'creator', '3': 2, '4': 1, '5': 9, '8': {}, '10': 'creator'},
    {'1': 'checksum', '3': 3, '4': 1, '5': 12, '8': {}, '10': 'checksum'},
    {'1': 'instantiate_permission', '3': 4, '4': 1, '5': 11, '6': '.cosmwasm.wasm.v1.AccessConfig', '8': {}, '10': 'instantiatePermission'},
  ],
  '7': {},
};

/// Descriptor for `QueryCodeInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryCodeInfoResponseDescriptor = $convert.base64Decode(
    'ChVRdWVyeUNvZGVJbmZvUmVzcG9uc2USIwoHY29kZV9pZBgBIAEoBEIK4t4fBkNvZGVJRFIGY2'
    '9kZUlkEjIKB2NyZWF0b3IYAiABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IHY3JlYXRv'
    'chJQCghjaGVja3N1bRgDIAEoDEI0+t4fMGdpdGh1Yi5jb20vY29tZXRiZnQvY29tZXRiZnQvbG'
    'licy9ieXRlcy5IZXhCeXRlc1IIY2hlY2tzdW0SYAoWaW5zdGFudGlhdGVfcGVybWlzc2lvbhgE'
    'IAEoCzIeLmNvc213YXNtLndhc20udjEuQWNjZXNzQ29uZmlnQgnI3h8AqOewKgFSFWluc3Rhbn'
    'RpYXRlUGVybWlzc2lvbjoE6KAfAQ==');
...
@$core.Deprecated('Use queryWasmLimitsConfigRequestDescriptor instead')
const QueryWasmLimitsConfigRequest$json = {
  '1': 'QueryWasmLimitsConfigRequest',
};

/// Descriptor for `QueryWasmLimitsConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryWasmLimitsConfigRequestDescriptor = $convert.base64Decode(
    'ChxRdWVyeVdhc21MaW1pdHNDb25maWdSZXF1ZXN0');

@$core.Deprecated('Use queryWasmLimitsConfigResponseDescriptor instead')
const QueryWasmLimitsConfigResponse$json = {
  '1': 'QueryWasmLimitsConfigResponse',
  '2': [
    {'1': 'config', '3': 1, '4': 1, '5': 9, '10': 'config'},
  ],
};

/// Descriptor for `QueryWasmLimitsConfigResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryWasmLimitsConfigResponseDescriptor = $convert.base64Decode(
    'Ch1RdWVyeVdhc21MaW1pdHNDb25maWdSZXNwb25zZRIWCgZjb25maWcYASABKAlSBmNvbmZpZw'
    '==');
