...
class ScalarType extends $pb.ProtobufEnum {
  static const ScalarType SCALAR_TYPE_UNSPECIFIED = ScalarType._(0, _omitEnumNames ? '' : 'SCALAR_TYPE_UNSPECIFIED');
  static const ScalarType SCALAR_TYPE_STRING = ScalarType._(1, _omitEnumNames ? '' : 'SCALAR_TYPE_STRING');
  static const ScalarType SCALAR_TYPE_BYTES = ScalarType._(2, _omitEnumNames ? '' : 'SCALAR_TYPE_BYTES');
