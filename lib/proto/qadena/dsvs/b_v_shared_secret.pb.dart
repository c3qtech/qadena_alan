...
class BVSharedSecret extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BVSharedSecret', package: const $pb.PackageName(_omitMessageNames ? '' : 'qadena.dsvs'), createEmptyInstance: create)
    ..aOM<$2.BECPoint>(1, _omitFieldNames ? '' : 'S1', protoName: 'S1', subBuilder: $2.BECPoint.create)
    ..aOM<$2.BECPoint>(2, _omitFieldNames ? '' : 'S2', protoName: 'S2', subBuilder: $2.BECPoint.create)
  ...
  @$pb.TagNumber(1)
  $2.BECPoint get s1 => $_getN(0);
  @$pb.TagNumber(1)
  set s1($2.BECPoint v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasS1() => $_has(0);
  @$pb.TagNumber(1)
  void clearS1() => clearField(1);
  @$pb.TagNumber(1)
  $2.BECPoint ensureS1() => $_ensure(0);

  @$pb.TagNumber(2)
  $2.BECPoint get s2 => $_getN(1);
  @$pb.TagNumber(2)
  set s2($2.BECPoint v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasS2() => $_has(1);
  @$pb.TagNumber(2)
  void clearS2() => clearField(2);
  @$pb.TagNumber(2)
  $2.BECPoint ensureS2() => $_ensure(1);
}
